...
export default class AddGoodsInfo extends PureComponent {
    ...
    componentDidMount = () => {
        ...
        if (params && params.defaultSort) {
            //把默认值赋值给默认分类
            this.defaultSort = [params.defaultSort.goodsCat, params.defaultSort.goodsBrand, params.defaultSort.goodsSort,]
        }
        //获取所有已经存在分类
        else {
            this.props.dispatch({
                ...
                <Card bordered={false}>
                    ...
                    <Form onSubmit={this.handleSubmit} style={{ marginTop: 8 }}>
                        ...
                        <FormItem {...submitFormLayout} style={{ marginTop: 32 }}>
                            ...
                            <Button style={{ marginLeft: 8 }} onClick={() => { this.props.history.goBack(); }}>
